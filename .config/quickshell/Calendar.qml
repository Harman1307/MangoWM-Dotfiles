        ...
        Item {
            ...
            Item {
                ...
                Row {
                    ...
                    Item { width: parent.width - navLeft.width - navRight.width - monthLabel.width - (isCurrentMonth ? 6 : 30); height: 1 }

                    Text { id: monthLabel; visible: false; text: monthNames[viewMonth] + " " + viewYear; font { pixelSize: 12; family: "JetBrainsMono Nerd Font" } }
